$(document).ready(function () {
    ...
    //tells html to show buttons
        ...
        console.log(band);
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + bands + "&api_key=Vb0lSKUoCEct0qrvHqqUYbobJJYABtKP&limit=10";
        $("#bands-view").empty();
...
// var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + videos + "&api_key=Vb0lSKUoCEct0qrvHqqUYbobJJYABtKP&limit=10";
